// src/pages/FichatecnicaS1000.tsx
...
export default function FichatecnicaS1000() {
  ...
  const pageTexts = {
    pt: {
      ...
      productName: "LJ Tech S1000 Orchard Sprayer",
      productDescription: "Pulverizador autónomo inteligente para pomares e culturas de precisão com navegação RTK e controlo dinâmico de pulverização.",
      ...
      sections: [
        ...
        { id: 'desempenho', label: 'Desempenho & Mobilidade', icon: Check, enLabel: 'Performance & Mobility' },
      ...
      specifications: {
        basicas: [
          { label: "Dimensões (CxLxA)", value: "3000 × 1350 × 1450 mm", enLabel: "Dimensions (LxWxH)" },
          { label: "Peso em vazio", value: "≈ 1350 kg", enLabel: "Unladen Weight" },
        ...
        desempenho: [
          { label: "Velocidade de Deslocamento", value: "0–5 km/h", enLabel: "Travel Speed" },
          { label: "Capacidade de Subida", value: "≤ 12 °", enLabel: "Climbing Capacity" },
          { label: "Autonomia Operacional", value: "≥ 8 h", enLabel: "Operational Autonomy" },
          { label: "Folga ao Solo", value: "≈ 180 mm", enLabel: "Ground Clearance" },
        ],
        sistema_pulverizacao: [
          { label: "Capacidade Tanque Principal", value: "1000 L", enLabel: "Main Tank Capacity" },
          { label: "Tanque de Limpeza", value: "50 L (com auto‑clean)", enLabel: "Cleaning Tank" },
          { label: "Pressão de Spray", value: "0–1.5 MPa", enLabel: "Spray Pressure" },
          { label: "Vazão", value: "0–80 L/min", enLabel: "Flow Rate" },
          { label: "Número de Bicos", value: "16", enLabel: "Number of Nozzles" },
          { label: "Tamanho de Gotas", value: "80–200 µm", enLabel: "Droplet Size" },
          { label: "Largura Pulverização", value: "30–40 m", enLabel: "Spraying Width" },
          { label: "Altura Pulverização", value: "8–12 m", enLabel: "Spraying Height" },
        ],
        navegacao: [
          { label: "Sistema de Navegação", value: "GNSS RTK + Visual", enLabel: "Navigation System" },
          { label: "Tecnologias Integradas", value: "GNSS + RTK + LiDAR + IMU + Visão Computacional", enLabel: "Integrated Technologies" },
          { label: "Precisão de Posicionamento", value: "±5 cm", enLabel: "Positioning Accuracy" },
          { label: "Gestão Inteligente", value: "Partilha de trajectória / Interrupção de pulverização nas curvas / Pulverização unilateral / Dosagem precisa / Alertas automáticos", enLabel: "Intelligent Management" },
        ],
        controlo: [
          ...
          { label: "Telemetria de dados", valor: "Sim", enLabel: "Data Telemetry" },
        ],
        motor: [
          { label: "Tipo de Energia", value: "Híbrido diesel + bateria", enLabel: "Energy Type" },
          { label: "Motor Diesel", value: "40 kW / 54 HP", enLabel: "Diesel Engine" },
          { label: "Supercap", value: "100 V Super‑Capacitor", enLabel: "Supercap" },
          { label: "Gerador", value: "20 kW", enLabel: "Generator" },
        ],
        garantia: [
      ...
      additionalInfoItems: [
        "Sistema de navegação automática por GPS RTK",
        "Controlo inteligente de pulverização baseado em sensores",
        "Monitorização remota via aplicação móvel",
        "Relatórios detalhados de operações",
        "Integração com sistemas de gestão agrícola",
        "Suporte para múltiplos tipos de culturas"
      ],
    ...
    en: {
      ...
      productName: "LJ Tech S1000 Orchard Sprayer",
      productDescription: "Intelligent autonomous sprayer for orchards and precision crops with RTK navigation and dynamic spray control.",
      ...
      sections: [
        ...
        { id: 'desempenho', label: 'Performance & Mobility', icon: Check, ptLabel: 'Desempenho & Mobilidade' },
      ...
      specifications: {
        basicas: [
          { label: "Dimensions (LxWxH)", value: "3000 × 1350 × 1450 mm", ptLabel: "Dimensões (CxLxA)" },
          { label: "Unladen Weight", value: "≈ 1350 kg", ptLabel: "Peso em vazio" },
          { label: "Chassis", value: "Track chassis", ptLabel: "Chassis" },
          { label: "Protection Rating", value: "IP55", ptLabel: "Classificação de Proteção" },
        ],
        desempenho: [
          { label: "Travel Speed", value: "0–5 km/h", ptLabel: "Velocidade de Deslocamento" },
          { label: "Climbing Capacity", value: "≤ 12 °", ptLabel: "Capacidade de Subida" },
          { label: "Operational Autonomy", value: "≥ 8 h", ptLabel: "Autonomia Operacional" },
          { label: "Ground Clearance", value: "≈ 180 mm", ptLabel: "Folga ao Solo" },
        ],
        sistema_pulverizacao: [
          { label: "Main Tank Capacity", value: "1000 L", ptLabel: "Capacidade Tanque Principal" },
          { label: "Cleaning Tank", value: "50 L (with auto‑clean)", ptLabel: "Tanque de Limpeza" },
          { label: "Spray Pressure", value: "0–1.5 MPa", ptLabel: "Pressão de Spray" },
          { label: "Flow Rate", value: "0–80 L/min", ptLabel: "Vazão" },
          { label: "Number of Nozzles", value: "16", ptLabel: "Número de Bicos" },
          { label: "Droplet Size", value: "80–200 µm", ptLabel: "Tamanho de Gotas" },
          { label: "Spraying Width", value: "30–40 m", ptLabel: "Largura Pulverização" },
          { label: "Spraying Height", value: "8–12 m", ptLabel: "Altura Pulverização" },
        ],
        navegacao: [
          { label: "Navigation System", value: "GNSS RTK + Visual", ptLabel: "Sistema de Navegação" },
          { label: "Integrated Technologies", value: "GNSS + RTK + LiDAR + IMU + Computer Vision", ptLabel: "Tecnologias Integradas" },
          { label: "Positioning Accuracy", value: "±5 cm", ptLabel: "Precisão de Posicionamento" },
          { label: "Intelligent Management", value: "Trajectory sharing / Spray interruption in curves / Unilateral spraying / Precise dosing / Automatic alerts", ptLabel: "Gestão Inteligente" },
        ],
        controlo: [
        ...
        motor: [
          { label: "Energy Type", value: "Diesel + battery hybrid", ptLabel: "Tipo de Energia" },
          { label: "Diesel Engine", value: "40 kW / 54 HP", ptLabel: "Motor Diesel" },
          { label: "Supercap", value: "100 V Super‑Capacitor", ptLabel: "Supercap" },
          { label: "Generator", value: "20 kW", ptLabel: "Gerador" },
        ],
        garantia: [
      ...
      additionalInfoItems: [
        "Automatic GPS RTK navigation system",
        "Intelligent spray control based on sensors",
  ...
  const produto = {
    nome: p.productName,
    codigo: language === 'pt' ? "LJTECH-S1000-PT" : "LJTECH-S1000-EN",
    versao: "1.0",
