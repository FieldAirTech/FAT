// src/pages/Produtos/SLJTecS1000Orchard.tsx
...
import { 
  ...
  Video, Cloud, Tree, Settings
} from "lucide-react";
import { useLanguage } from "../../contexts/LanguageContext";
import { translations } from '../../i18n/translations';

export default function SLJTecS1000OrchardPage() {
  ...
  const pageTexts = useMemo(() => ({
    pt: {
      ...
      // Alt texts
      altHero: "LJ Tech S1000 Orchard Sprayer em operação",
      altPrecisionSpray: "Sistema de pulverização de precisão",
      altDeployment: "Diagrama de planeamento de operações",
      altAppInterface: "Interface da app Orchard Mate"
    },
    ...
    en: {
      ...
      // Alt texts
      altHero: "LJ Tech S1000 Orchard Sprayer in operation",
      altPrecisionSpray: "Precision spraying system",
      altDeployment: "Operation planning diagram",
      altAppInterface: "Orchard Mate app interface"
    }
  }), [language]);
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img 
                src="https://i.imgur.com/h646jHd.png" 
                alt={p.altHero}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative aspect-video rounded-xl overflow-hidden shadow-2xl bg-black">
            <div className="absolute inset-0 overflow-hidden rounded-xl">
              <iframe 
                src="https://www.youtube-nocookie.com/embed/uoekMbRoYfM?autoplay=1&controls=0&modestbranding=1&rel=0&loop=1&playlist=uoekMbRoYfM&showinfo=0&iv_load_policy=3&disablekb=1&fs=0&start=8&volume=35"
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <img 
                src="https://i.imgur.com/Eb5NRyb.png" 
